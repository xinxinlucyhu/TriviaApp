...
public class TriviaController
{
    ...
    @PostMapping("/final")
    public String submitAnswer(UserInput userInput, Model model)
    {   
        System.out.println("length " + ((List)model.getAttribute("triviaQuestions")).size());
        
        model.addAttribute("submitAnswer", userInput);
        
        System.out.println(((UserInput)model.getAttribute("submitAnswer")).getAnswer());
        return "final";
